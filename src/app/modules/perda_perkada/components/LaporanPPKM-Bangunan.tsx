...
import { DtPPKMBangunan, DtDetail } from './datatables/data-table-laporan-ppkm'
            ...
            <div className='card'>
                ...
                <div className='row'>
                    <div className='col fs-4 mb-2 fw-semibold text-center'>
                        LAPORAN HASIL PENGAWASAN DAN PENINDAKAN  PERKANTORAN / TEMPAT KERJA, TEMPAT USAHA, TEMPAT INDUSTRI, PERHOTELAN/ PENGINAPAN LAIN
                    </div>
                </div>
                <div className='row'>
                    <div className='col fs-4 mb-2 fw-semibold text-center'>
