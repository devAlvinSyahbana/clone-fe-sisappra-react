...
import { DtPPKMMasker, DtDetail } from './datatables/data-table-laporan-ppkm'
...
export function LaporanPPKMMasker() {
            ...
            <div className='card'>
                ...
                <div className='row'>
                    <div className='col fs-4 mb-2 fw-semibold text-center'>
                        LAPORAN HASIL KEGIATAN PENINDAKAN PENGGUNAAN MASKER
                    </div>
                </div>
                <div className='row'>
                    <div className='col fs-4 mb-2 fw-semibold text-center'>
