...
export const JENIS_KEGITAN_URL = `${API_URL}/master/jenis-kegiatan` //http://localhost:3000/jenis-kegiata
...
export function LihatJenisKegiatan() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`${JENIS_KEGITAN_URL}/findone/${id}`)
