...
export const StepTindaklanjut: FC = () => {
    ...
    const listJenisPenindakan = useSelector((s: RootState) => s.pelaporanKegiatan.list_jenis_penindakan)
    const listJenisPenyelesaian = useSelector((s: RootState) => s.pelaporanKegiatan.list_jenis_penyelesaian)
