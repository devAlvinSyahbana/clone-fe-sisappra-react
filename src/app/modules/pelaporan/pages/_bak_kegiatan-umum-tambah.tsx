...
import {StepPilihKegiatan} from "./steps/step-pilih-kegiatan";
import {StepDetailKegiatan} from "./steps/step-detail-kegiatan";

const AddKegiatanUmumPage: FC = () => {
                ...
                >
                    <div className='stepper-nav mb-5'>
                        <div className='stepper-item current' data-kt-stepper-element='nav'>
                            <h3 className='stepper-title'>Pilih Kegiatan</h3>
                        </div>

                        <div className='stepper-item' data-kt-stepper-element='nav'>
                            <h3 className='stepper-title'>Detail Kegiatan</h3>
                        </div>

                        <div className='stepper-item' data-kt-stepper-element='nav'>
                            <h3 className='stepper-title'>Tindak Lanjut</h3>
                        </div>

                        <div className='stepper-item' data-kt-stepper-element='nav'>
                            <h3 className='stepper-title'>Dokumentasi</h3>
                        </div>
                        ...
                        <div className='stepper-item' data-kt-stepper-element='nav'>
                            <h3 className='stepper-title'>Periksa</h3>
                        </div>
                    </div>
