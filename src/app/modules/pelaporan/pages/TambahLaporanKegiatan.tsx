                    ...
                    <div className='form-group'>
                      <TabPanel>
                        ...
                        <div className='form-group'>
                          <div className='row mb-10'>
                            ...
                            <div className='col-md-4'>
                              ...
                              >
                                ...
                                <option value='b'>Non Yustisi (Pembinaan)</option>
                              </select>
                            </div>
                          </div>
                          {/* <div className="form-group">
                          ...
                          <div className='row mb-10'>
                            <div className='col-md-2'>
                              <label className='col-form-label fw-semibold fs-6'>Nomor BAP</label>
                            </div>
                            <div className='col-md-4'>
                              <input
                                type='text'
