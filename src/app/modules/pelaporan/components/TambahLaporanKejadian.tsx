                        ...
                        <div className="row mb-10">
                          ...
                          <div className="col-md-4">
                            <select className="form-select form-select-solid" data-control="select2"
                              ...
                              <option></option>
                              <option value="Select All">Pohon Tumbang</option>
                              <option value="a">Pohon Tumbang</option>
                              <option value="b">Kebakaran</option>
                              <option value="a">Tawuran</option>
                              <option value="b">Penemuan Mayat</option>
                              <option value="a">Kecelakaan</option>
                              <option value="b">Terorisme</option>
                              <option value="a">Penyelamatan Orang</option>
                              <option value="b">Kerusakan Konstruksi</option>
                              <option value="a">Unjuk Rasa</option>
                              <option value="b">Kriminalitas</option>
                              <option value="a">Hewan Buas dan Berbisa</option>
                              <option value="b">Pembunuhan</option>
                              <option value="a">Pendampingan Kekerasan pada Ibu dan Anak</option>
                              <option value="b">Banjir</option>
                            </select>
                          </div>
                        </div>
