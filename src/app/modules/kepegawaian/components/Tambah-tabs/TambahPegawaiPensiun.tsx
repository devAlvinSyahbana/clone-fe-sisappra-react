...
export function TambahPegawaiPensiun() {
    ...
    return (
        <div className='card mb-5 mb-xl-10'>
            ...
            <div className="card-body p-9">
                ...
                <div className="row mb-10">
                    <div className="col-md-2">
                        <label className="col-form-label fw-semibold fs-6">Tempat Wilayah/Bidang</label>
                    </div>
                    <div className="col-md-4">
                        <input type="text" placeholder="Wilayah" disabled
                            className="form-control form-control-lg form-control-solid mb-3 mb-lg-0"></input>
                    </div>
                </div>
                <div className="row mb-10">
                ...
                <div className="row mb-10">
                    ...
                    <div className="col-md-4">
                        <input type="text" placeholder="Seksi" disabled
                            className="form-control form-control-lg form-control-solid mb-3 mb-lg-0"></input>
                    </div>
                </div>
                <div className="row mb-10">
                    <div className="col-md-2">
                        <label className="col-form-label fw-semibold fs-6">Tempat Lahir</label>
                    </div>
                    <div className="col-md-4">
                        <input type="text" placeholder="Tempat" disabled
                            className="form-control form-control-lg form-control-solid mb-3 mb-lg-0"></input>
                    </div>
                </div>
                <div className="row mb-10">
                    <div className="col-md-2">
                        <label className="col-form-label fw-semibold fs-6">Tanggal Lahir</label>
                    </div>
                    <div className="col-md-4">
                ...
                <div className="row mb-10">
                    <div className="col-md-2">
                        <label className="col-form-label fw-semibold fs-6">Tahun Pensiun</label>
                    </div>
                    <div className="col-md-4">
                ...
                <div className="row mb-10">
                    ...
                    <div className="col-md-4">
                        <textarea className="form-control form-control" data-kt-autosize="true"
                            placeholder="Kenapa bisa pensiun?"></textarea>
                    </div>
                </div>
            </div>
            {/* Footer */}
