            ...
            <div className='card mb-5 mb-xl-10'>
              <div className='card-body'>
                <form>
                  <div className='form-group'>
                    ...
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6 col-md-5'>
                          TMT Pangkat
                        </label>
                      </div>
                      <div className='col-md-4'>
                    ...
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6'>Eselon</label>
                      </div>
                      <div className='col-md-4'>
                        <input
                          className='form-control form-control-solid'
                    ...
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6'>
                          Tempat Tugas Wilayah/Bidang
                        </label>
                      </div>
                      <div className='col-md-4'>
                        <input
                          className='form-control form-control-solid'
                          placeholder='Tempat Tugas Wilayah/Bidang'
                          id='kt_datepicker_time'
                        ></input>
                      </div>
                    </div>
                    <div className='row mb-10'>
                      ...
                      <div className='col-md-4'>
                        <input
                          className='form-control form-control-solid'
                          placeholder='Tempat Tugas Kecamatan/Seksi'
                          id='kt_datepicker_time'
                        ></input>
                      </div>
                    </div>
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6'>Golongan</label>
                      </div>
                      <div className='col-md-4'>
                        <input
                          className='form-control form-control-solid'
                    ...
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6 col-md-'>
                          Status Kenaikan
                        </label>
                      </div>
                      <div className='col-md-4'>
                    ...
                    <div className='row mb-10'>
                      <div className='col-md-2'>
                        <label className='col-form-label fw-semibold fs-6 col-md-4'>
                          Jadwal Kenaikan
                        </label>
                      </div>
                      <div className='col-md-4'>
              ...
              <div className='card-footer'>
                <div className='d-grid gap-2 d-md-flex justify-content-md-center'>
                  <Link to='/kepegawaian/TabDataPegawaiYangNaikPangkat'>
