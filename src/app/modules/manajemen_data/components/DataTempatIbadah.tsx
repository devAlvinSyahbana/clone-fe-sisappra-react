...
export function DataTempatIbadah() {
  ...
  const columns = [
    ...
    {
      name: 'Tempat Ibadah',
      selector: (row: any) => row.tempat_ibadah,
      sortable: true,
      sortField: 'tempat_ibadah',
      wrap: true,
    },
    {
      name: 'Alamat',
    ...
    {
      name: 'Nama Pengurus',
      selector: (row: any) => row.nama_pengurus,
      sortable: true,
      sortField: 'nama_pengurus',
      width: '200px',
      wrap: true,
    },
    {
      name: 'Tahun Pendiri',
      selector: (row: any) => row.tahun_pendiri,
      sortable: true,
      sortField: 'tahun_pendiri',
      wrap: true,
    },
    {
      name: 'Bentuk Bangunan',
      selector: (row: any) => row.bentuk_bangunan,
      sortable: true,
      sortField: 'bentuk_bangunan',
      wrap: true,
    },
    {
      name: 'Sumber Biaya',
      selector: (row: any) => row.sumber_biaya,
      sortable: true,
      sortField: 'sumber_biaya',
      wrap: true,
    },
  ]
  ...
  useEffect(() => {
    async function fetchDT(page: number) {
      ...
      const response = await axios.get(
        `${PELAKSANA_URL}/sdsfind?limit=${perPage}&offset=${page}${qParamFind.strparam}`
      )
  ...
  const fetchData = async (page: number) => {
    setLoading(true)
    const response = await axios.get(
      `${PELAKSANA_URL}/sdsdfind?limit=${perPage}&offset=${page}${qParamFind.strparam}`
    )
    setData(response.data.data)
    setTotalRows(response.data.total_data)
    setLoading(false)
  ...
  const handlePerRowsChange = async (newPerPage: number, page: number) => {
    setLoading(true)
    const response = await axios.get(
      `${PELAKSANA_URL}/sdsfind?limit=${newPerPage}&offset=${page}${qParamFind.strparam}`
    )
    setData(response.data.data)
  ...
  const handleUnduh = async () => {
    ...
    await axios({
      url: `${PELAKSANA_URL}/unduh?status=${qParamFind.strparam}`,
      method: 'GET',
              ...
              >
                <form onSubmit={formik.handleSubmit}>
                  <Modal.Header closeButton>
                    <Modal.Title>Tambah Data Tempat Ibadah </Modal.Title>
                  </Modal.Header>
                  <Modal.Body>
                    <div className='row mt-2'>
                      ...
                      <div className='row mt-2'>
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Tempat Ibadah</Form.Label>
                            <Form.Control
                              name='pangkat'
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Pemberi Wakaf</Form.Label>
                            <Form.Control
                              name='eselon'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Status Tanah</Form.Label>
                            <Form.Control
                              name='tempat_tugas'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Tahun Pendiri</Form.Label>
                            <Form.Control
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Bentuk Bangunan</Form.Label>
                            <Form.Control
                              name='golongan'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Peruntukan Lahan</Form.Label>
                            <Form.Control
                              name='golongan'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Daya Tampung</Form.Label>
                            <Form.Control
                              className='form-control form-control form-control-solid'
                              name='jumlah'
                              type='number'
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Luas Bangunan</Form.Label>
                            <Form.Control
                              name='golongan'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Luas Tanah</Form.Label>
                            <Form.Control
                              name='golongan'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
                        ...
                        <div className='col-4 mb-3'>
                          <div className='form-group'>
                            <Form.Label>Kegiatan Lain</Form.Label>
                            <Form.Control
                              name='golongan'
                              className='form-control form-control-solid'
                              // onChange={handleChangeFormik}
