...
export function DataTitikPlotingAnggota() {
  ...
  const columns = [
    ...
    {
      name: 'Kota/Kabupaten Administrasi',
    ...
    {
      name: 'Jam Penjagaan Pagi',
      selector: (row: any) => row.jam_penjagaan_pagi,
      sortable: true,
      sortField: 'jam_penjagaan_pagi',
      width: '200px',
      wrap: true,
    },
    {
      name: 'Total Personil Penjagaan Pagi',
      selector: (row: any) => row.total_personil_penjagaan_pagi,
      sortable: true,
      sortField: 'total_personil_penjagaan_pagi',
      width: '200px',
      wrap: true,
    },
    {
      name: 'Jam Penjagaan Sore',
      selector: (row: any) => row.jm_penjagaan_sore,
      sortable: true,
      sortField: 'jm_penjagaan_sore',
      width: '200px',
      wrap: true,
    },
    {
