  ...
  return (
    <>
      ...
      >
        ...
        <SidebarMenuItem to='/master/jenis_kegiatan' title='Jenis Kegiatan' hasBullet={true} />
        <SidebarMenuItem to='/master/jenis_kejadian' title='Jenis Kejadian' hasBullet={true} />
